...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x2018; //address starts with SU
...
const char     CRYPTONOTE_NAME[]                             = "Superposition";
...
const int      P2P_DEFAULT_PORT                              = 36525;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 36526;
